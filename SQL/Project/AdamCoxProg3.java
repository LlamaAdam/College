...
public class AdamCoxProg3 {
	...
	public static void main(String args[]) {
		...
		Connection con = null;
		Statement stmt = null;
		String createString1 = "SELECT r.WorkoutID, r.ExerciseName, r.Sets, r.Weights_Used, w.WeightType, w.WeightIncruments FROM workout r JOIN weights w ON w.weightid=r.weights_used";
