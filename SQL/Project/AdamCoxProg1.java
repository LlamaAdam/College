...
public class AdamCoxProg1 {
	...
	public static void main(String args[]) {
		...
		Connection con = null;
		Statement stmt = null;
		String createString1 = " SELECT c.ClientID, c.FirstName, c.LasstName,t.trainerID, t.FirstName, t.LasstName, ContractNo  FROM client c JOIN contract o USING (ClientID) JOIN trainer t USING (trainerid)";
